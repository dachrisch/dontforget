...
const EN = {
  ...
  'googleModal.title': 'Add to Google Calendar',
  'googleModal.intro': "Google Calendar can't subscribe to a feed with one click — you'll add it manually in about 30 seconds.",
  'googleModal.step1': 'Copy your calendar link.',
  'googleModal.step2': 'Open Google Calendar\'s "Add from URL" page.',
  'googleModal.step3': 'Paste the link into the URL field and click "Add calendar".',
  'googleModal.copy': 'Copy link',
  'googleModal.open': 'Open Google Calendar',
  'googleModal.copied': 'Link copied',
  'googleModal.copyHint': "Copying didn't work automatically — select the link below and copy it by hand.",
  'googleModal.done': 'Done',
  'googleModal.close': 'Close',
  ...
  'admin.searchTitle': 'Search health (7 days)',
  'admin.searchCalls': 'Searches',
  'admin.searchErrorRate': 'Error rate',
  'admin.searchAvgLatency': 'Avg latency',
  'admin.searchAvgResults': 'Avg results',
  'admin.searchLastError': 'Last error: {at}',
  'admin.modelsTitle': 'Models (7 days)',
  'admin.model': 'Model',
  'admin.modelRole': 'Role',
  'admin.modelStatus': 'Status',
  'admin.modelSuccess': 'Success rate',
  'admin.modelLatency': 'Avg latency',
  'admin.modelRoleDefault': 'Default',
  'admin.modelRoleBackup': 'Backup',
  'admin.modelEnabled': 'Enabled',
  'admin.modelRetired': 'Retired',
  'admin.modelSetDefault': 'Set default',
  'admin.modelSetBackup': 'Set backup',
  'admin.modelEnable': 'Enable',
  'admin.modelRetire': 'Retire',
  'admin.noModels': 'No models configured yet.',
  'admin.addModel': 'Add model',
  'admin.addModelId': 'Model id',
  'admin.addModelProvider': 'Provider id',
  ...
  'queryCard.series': 'Series',
  'queryCard.seriesStats': '{found} series · {subscribed} subscribed',
  'queryCard.subscribed': 'Subscribed',
  'queryCard.edit': 'Edit',
  'queryCard.delete': 'Delete',
  'queryCard.confirmDelete': 'Confirm delete?',
  'queryCard.review': 'Review',
  'series.subscribe': 'Subscribe',
  'series.unsubscribe': 'Unsubscribe',
  'series.next': 'next {date}',
  'series.dateCount': '{count} dates',
  'series.details': 'details',
  'series.noDates': 'No dates found yet — we keep checking on every run and they appear here once published.',
  ...
  'edit.save': 'Save',
  'edit.series': 'Series',
  'edit.seriesLoading': 'Loading series…',
  'edit.searchingDates': 'Searching dates…',
  'edit.seriesHint': 'Tick a series to subscribe — its dates are searched automatically. Unticked dates are removed on save; you can also remove single dates later from your calendar.',
  'edit.legacyDates': 'Older dates',
  'edit.cancel': 'Cancel',
  ...
  'error.subscribing': 'Something went wrong while updating the subscription. Please try again.',
  'error.loadingEvents': 'Something went wrong while loading events. Please try again.',
  'error.loadingSeries': 'Something went wrong while loading series. Please try again.',
  ...
  'error.updatingModel': 'Something went wrong while updating the model. Please try again.',
  'error.addingModel': 'Something went wrong while adding the model. Please try again.',
} as const;
...
const DE: Record<MessageKey, string> = {
  ...
  'googleModal.title': 'Zu Google Kalender hinzufügen',
  'googleModal.intro': 'Google Kalender kann einen Feed nicht per Klick abonnieren — du fügst ihn manuell hinzu. Dauert etwa 30 Sekunden.',
  'googleModal.step1': 'Kopiere deinen Kalender-Link.',
  'googleModal.step2': 'Öffne die Seite „Aus URL hinzufügen“ von Google Kalender.',
  'googleModal.step3': 'Füge den Link in das URL-Feld ein und klicke auf „Kalender hinzufügen“.',
  'googleModal.copy': 'Link kopieren',
  'googleModal.open': 'Google Kalender öffnen',
  'googleModal.copied': 'Link kopiert',
  'googleModal.copyHint': 'Automatisches Kopieren hat nicht funktioniert — wähle den Link unten aus und kopiere ihn manuell.',
  'googleModal.done': 'Fertig',
  'googleModal.close': 'Schließen',
  ...
  'admin.searchTitle': 'Suche-Verfügbarkeit (7 Tage)',
  'admin.searchCalls': 'Suchen',
  'admin.searchErrorRate': 'Fehlerquote',
  'admin.searchAvgLatency': 'Ø Latenz',
  'admin.searchAvgResults': 'Ø Ergebnisse',
  'admin.searchLastError': 'Letzter Fehler: {at}',
  'admin.modelsTitle': 'Modelle (7 Tage)',
  'admin.model': 'Modell',
  'admin.modelRole': 'Rolle',
  'admin.modelStatus': 'Status',
  'admin.modelSuccess': 'Erfolgsquote',
  'admin.modelLatency': 'Ø Latenz',
  'admin.modelRoleDefault': 'Standard',
  'admin.modelRoleBackup': 'Backup',
  'admin.modelEnabled': 'Aktiv',
  'admin.modelRetired': 'Ausgemustert',
  'admin.modelSetDefault': 'Als Standard',
  'admin.modelSetBackup': 'Als Backup',
  'admin.modelEnable': 'Aktivieren',
  'admin.modelRetire': 'Ausmustern',
  'admin.noModels': 'Noch keine Modelle konfiguriert.',
  'admin.addModel': 'Modell hinzufügen',
  'admin.addModelId': 'Modell-ID',
  'admin.addModelProvider': 'Provider-ID',
  ...
  'queryCard.series': 'Serien',
  'queryCard.seriesStats': '{found} Serien · {subscribed} abonniert',
  'queryCard.subscribed': 'Abonniert',
  'queryCard.edit': 'Bearbeiten',
  'queryCard.delete': 'Löschen',
  'queryCard.confirmDelete': 'Löschen bestätigen?',
  'queryCard.review': 'Prüfen',
  'series.subscribe': 'Abonnieren',
  'series.unsubscribe': 'Abbestellen',
  'series.next': 'nächster {date}',
  'series.dateCount': '{count} Termine',
  'series.details': 'Details',
  'series.noDates': 'Noch keine Termine gefunden — wir prüfen bei jedem Lauf erneut und sie erscheinen hier, sobald sie veröffentlicht sind.',
  ...
  'edit.save': 'Speichern',
  'edit.series': 'Serien',
  'edit.seriesLoading': 'Serien werden geladen…',
  'edit.searchingDates': 'Termine werden gesucht…',
  'edit.seriesHint': 'Hake eine Serie an, um sie zu abonnieren — ihre Termine werden automatisch gesucht. Abgewählte Termine werden beim Speichern entfernt; einzelne Termine kannst du später auch im Kalender entfernen.',
  'edit.legacyDates': 'Ältere Termine',
  ...
  'error.subscribing': 'Beim Ändern des Abos ist etwas schiefgegangen. Bitte versuch es erneut.',
  'error.loadingEvents': 'Beim Laden der Termine ist etwas schiefgegangen. Bitte versuch es erneut.',
  'error.loadingSeries': 'Beim Laden der Serien ist etwas schiefgegangen. Bitte versuch es erneut.',
  ...
  'error.updatingModel': 'Beim Aktualisieren des Modells ist etwas schiefgegangen. Bitte versuch es erneut.',
  'error.addingModel': 'Beim Hinzufügen des Modells ist etwas schiefgegangen. Bitte versuch es erneut.',
};
