...
const EN = {
  ...
  'series.statusCandidate': 'Not subscribed',
  'series.statusApproved': 'Subscribed',
  'series.statusDismissed': 'Unsubscribed',
  'series.upcomingDates': 'Upcoming dates',
  'series.noDates': 'No dates yet — they appear here after the next run.',
  'series.hint': 'Subscribe to a series and its dates flow into your calendar automatically. Dismiss single dates from the calendar entry.',
...
const DE: Record<MessageKey, string> = {
  ...
  'series.statusCandidate': 'Nicht abonniert',
  'series.statusApproved': 'Abonniert',
  'series.statusDismissed': 'Abo beendet',
  'series.upcomingDates': 'Nächste Termine',
  'series.noDates': 'Noch keine Termine — sie erscheinen hier nach dem nächsten Lauf.',
  'series.hint': 'Abonniere eine Serie — ihre Termine fließen automatisch in deinen Kalender. Einzelne Termine entfernst du direkt im Kalendereintrag.',
