...
const EN = {
  ...
  'series.hint': 'Tap a series to subscribe — its dates land on your calendar automatically.',
  ...
  'edit.save': 'Save',
  'edit.seriesHint': 'Dates are read-only here — subscribe per series above, approve or dismiss single dates from your calendar.',
...
const DE: Record<MessageKey, string> = {
  ...
  'series.hint': 'Tippe auf eine Serie, um sie zu abonnieren — ihre Termine landen automatisch in deinem Kalender.',
  ...
  'edit.save': 'Speichern',
  'edit.seriesHint': 'Termine sind hier schreibgeschützt — pro Serie oben abonnieren, einzelne Termine im Kalender bestätigen oder entfernen.',
