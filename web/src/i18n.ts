...
const DE: Record<MessageKey, string> = {
  ...
  'billing.subscribed': 'Abo aktiv — {count} aktive Suchanfrage/n',
  'billing.freeLimit': '{count} kostenlose Suchanfrage/n übrig',
  'billing.perQuery': '{price} € pro zusätzlicher Suchanfrage',
  'admin.nav': 'Admin',
  'admin.title': 'Admin',
